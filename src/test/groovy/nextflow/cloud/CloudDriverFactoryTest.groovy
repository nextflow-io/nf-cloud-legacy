...
import nextflow.cloud.google.GoogleCloudDriver
...
class CloudDriverFactoryTest extends Specification {
    ...
    def 'should load at least on driver' () {
        ...
        then:
        found.size()>0
        found.aws == AmazonCloudDriver.class
        found.google == GoogleCloudDriver
        found.fake == FakeCloudDriver

    }

    def 'should return a set of names'() {
        expect:
        CloudDriverFactory.getDriverNames()  == ['fake','aws','google'] as Set
    }
